...
class PotraitRandomCoinRightSideDT extends StatefulWidget {
  const PotraitRandomCoinRightSideDT({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _PotraitRandomCoinRightSideDTState createState() =>
      _PotraitRandomCoinRightSideDTState();
}

class _PotraitRandomCoinRightSideDTState
    extends State<PotraitRandomCoinRightSideDT>
