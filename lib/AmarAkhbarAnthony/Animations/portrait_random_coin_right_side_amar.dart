...
class PotraitRandomCoinRightSideL7Amar extends StatefulWidget {
  const PotraitRandomCoinRightSideL7Amar({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _PotraitRandomCoinRightSideL7AmarState createState() =>
      _PotraitRandomCoinRightSideL7AmarState();
}

class _PotraitRandomCoinRightSideL7AmarState
    extends State<PotraitRandomCoinRightSideL7Amar>
