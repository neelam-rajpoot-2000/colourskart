...
class PotraitRandomCoinLeftSideL7Amar extends StatefulWidget {
  late final bool coinsSound;
  PotraitRandomCoinLeftSideL7Amar({super.key, required this.coinsSound});

  @override
  // ignore: library_private_types_in_public_api
  _PotraitRandomCoinLeftSideL7AmarState createState() =>
      _PotraitRandomCoinLeftSideL7AmarState();
}

class _PotraitRandomCoinLeftSideL7AmarState
    extends State<PotraitRandomCoinLeftSideL7Amar>
