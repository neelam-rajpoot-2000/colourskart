...
class PotraitRandomCoinRightSideBollywood extends StatefulWidget {
  const PotraitRandomCoinRightSideBollywood({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _PotraitRandomCoinRightSideBollywoodState createState() =>
      _PotraitRandomCoinRightSideBollywoodState();
}

class _PotraitRandomCoinRightSideBollywoodState
    extends State<PotraitRandomCoinRightSideBollywood>
