...
class PotraitRandomCoinLeftSideBollyWood extends StatefulWidget {
  late final bool coinsSound;
  PotraitRandomCoinLeftSideBollyWood({super.key, required this.coinsSound});

  @override
  // ignore: library_private_types_in_public_api
  _PotraitRandomCoinLeftSideBollyWoodState createState() =>
      _PotraitRandomCoinLeftSideBollyWoodState();
}

class _PotraitRandomCoinLeftSideBollyWoodState
    extends State<PotraitRandomCoinLeftSideBollyWood>
