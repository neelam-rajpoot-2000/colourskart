...
class LandscapeRandomCoinLeftSideBollWood extends StatefulWidget {
  late final bool coinsSound;
  LandscapeRandomCoinLeftSideBollWood({super.key, required this.coinsSound});

  @override
  // ignore: library_private_types_in_public_api
  _LandscapeRandomCoinLeftSideBollWoodState createState() =>
      _LandscapeRandomCoinLeftSideBollWoodState();
}

class _LandscapeRandomCoinLeftSideBollWoodState
    extends State<LandscapeRandomCoinLeftSideBollWood>
