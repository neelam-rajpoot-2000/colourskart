...
class PotraitRandomCoinLeftSideLDTL extends StatefulWidget {
  late final bool coinsSound;
  PotraitRandomCoinLeftSideLDTL({super.key, required this.coinsSound});

  @override
  // ignore: library_private_types_in_public_api
  _PotraitRandomCoinLeftSideLDTLState createState() =>
      _PotraitRandomCoinLeftSideLDTLState();
}

class _PotraitRandomCoinLeftSideLDTLState
    extends State<PotraitRandomCoinLeftSideLDTL>
