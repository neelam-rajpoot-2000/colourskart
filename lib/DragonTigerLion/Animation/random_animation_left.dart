...
class LandscapeRandomCoinLeftSideDTL extends StatefulWidget {
  late final bool coinsSound;
  LandscapeRandomCoinLeftSideDTL({super.key, required this.coinsSound});

  @override
  // ignore: library_private_types_in_public_api
  _LandscapeRandomCoinLeftSideDTLState createState() =>
      _LandscapeRandomCoinLeftSideDTLState();
}

class _LandscapeRandomCoinLeftSideDTLState
    extends State<LandscapeRandomCoinLeftSideDTL>
