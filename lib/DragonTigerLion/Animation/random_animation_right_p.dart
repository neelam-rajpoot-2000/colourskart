...
class PotraitRandomCoinRightSideDTL extends StatefulWidget {
  const PotraitRandomCoinRightSideDTL({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _PotraitRandomCoinRightSideDTLState createState() =>
      _PotraitRandomCoinRightSideDTLState();
}

class _PotraitRandomCoinRightSideDTLState
    extends State<PotraitRandomCoinRightSideDTL>
