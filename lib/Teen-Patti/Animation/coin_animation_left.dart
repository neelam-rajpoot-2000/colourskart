...
class LandscapeRandomCoinLeftSide extends StatefulWidget {
  late final bool coinsSound;
  LandscapeRandomCoinLeftSide({super.key, required this.coinsSound});

  @override
  // ignore: library_private_types_in_public_api
  _LandscapeRandomCoinLeftSideState createState() =>
      _LandscapeRandomCoinLeftSideState();
}

class _LandscapeRandomCoinLeftSideState
    extends State<LandscapeRandomCoinLeftSide>
