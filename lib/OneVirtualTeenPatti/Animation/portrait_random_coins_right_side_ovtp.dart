...
class PotraitRandomCoinRightSideOVTP extends StatefulWidget {
  const PotraitRandomCoinRightSideOVTP({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _PotraitRandomCoinRightSideOVTPState createState() =>
      _PotraitRandomCoinRightSideOVTPState();
}

class _PotraitRandomCoinRightSideOVTPState
    extends State<PotraitRandomCoinRightSideOVTP>
