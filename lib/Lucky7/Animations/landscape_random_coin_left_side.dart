...
class LandscapeRandomCoinLeftSideL7 extends StatefulWidget {
  late final bool coinsSound;
  LandscapeRandomCoinLeftSideL7({super.key, required this.coinsSound});

  @override
  // ignore: library_private_types_in_public_api
  _LandscapeRandomCoinLeftSideL7State createState() =>
      _LandscapeRandomCoinLeftSideL7State();
}

class _LandscapeRandomCoinLeftSideL7State
    extends State<LandscapeRandomCoinLeftSideL7>
