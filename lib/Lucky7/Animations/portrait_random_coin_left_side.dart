...
class PotraitRandomCoinLeftSideL7 extends StatefulWidget {
  late final bool coinsSound;
  PotraitRandomCoinLeftSideL7({super.key, required this.coinsSound});

  @override
  // ignore: library_private_types_in_public_api
  _PotraitRandomCoinLeftSideL7State createState() =>
      _PotraitRandomCoinLeftSideL7State();
}

class _PotraitRandomCoinLeftSideL7State
    extends State<PotraitRandomCoinLeftSideL7>
